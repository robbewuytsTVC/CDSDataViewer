		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CDS Data Viewer",
									"targetURL": "#CDSDataViewer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CDSDataViewer-display": {
								"semanticObject": "CDSDataViewer",
								"action": "display",
								"description": "CDS Data Viewer",
								"title": "CDS Data Viewer",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.adbsafegate.CDSViewer",
									"url": sap.ui.require.toUrl("com/adbsafegate/CDSViewer")
								}
							}
						}
					}
